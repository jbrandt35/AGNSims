...
sed -i "s|WORKDIR|/storage/home/hhive1/jbrandt35/data/AGN_sims/Storage/slurm-test/runs/BBH_separation_${BBH_separation}/perturber_separation_${perturber_separation}/${i}|g" BBH_separation_$BBH_separation/perturber_separation_$perturber_separation/${i}/submit.sbatch
